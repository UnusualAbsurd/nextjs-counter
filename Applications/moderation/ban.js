...
module.exports = {
  ...
  options: [
    { name: 'user', description: "The user that you want to ban", type: "USER", required: true },
    { name: 'reason', description: "The reason that you want to ban the user", type: "STRING", required: false },
  ],
  /** 
   * @param {Client} client 
