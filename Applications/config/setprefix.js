...
const {
  newGuild
} = require('../../functions/guild/createGuild')
...
module.exports = {
    ...
    async execute(client, interaction, args) {
        ...
        data.save(function() {
          interaction.reply({
                embeds: [new MessageEmbed().setDescription(`Successfully changed **${interaction.guild.name}** prefix into \`${prefix[0]}\``).setTimestamp().setColor(client.config.color)]
            })
        })
